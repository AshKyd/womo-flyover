...
const dbPath = process.env.DB_PATH || path.resolve(__dirname, '../../', 'flights.db');
...
/**
 * Query all rows between two ISO 8601 timestamps.
 * @param {string} startTimestamp 
 * @param {string} endTimestamp 
 * @param {Function} callback - Receives (err, rows)
 */
